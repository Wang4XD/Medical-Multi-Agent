...
if __name__ == '__main__':
    ...
    # Model Args
    parser.add_argument('--data_path', default=r'C:\Users\Administrator\Desktop\agent\temp\temp\medical_multimodel_evaluation_data.json', type=str)
    parser.add_argument('--model_path', default=r'C:\Users\Administrator\Desktop\agent\model\HuatuoGPT-Vision-7B', type=str)
